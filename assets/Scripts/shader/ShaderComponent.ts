...
export default class ShaderComponent extends cc.Component {
    ...
    private _applyShader() {
        ...
        switch (shader) {
            ...
            case ShaderType.GaussBlur:
                material.setNum(0.01); //0-0.1
                break;
            case ShaderType.OutLineSobel:
                material.setProp("_EdgeWidth",0.5);
                material.setProp("_EdgeColor",{r:0.0,g:0.0,b:0.0,a:1.0})
                material.setProp("_BackgroundColor",{r:1.0,g:1.0,b:1.0,a:1.0})
                material.setProp("_EdgeOnly",0.0);
                material.setProp('noiseTex',this.texture[0].getImpl());   
                break;
            case ShaderType.OutLineRoberts:
                material.setProp("_EdgeWidth",2.5);
                material.setProp("_EdgeColor",{r:0.0,g:0.0,b:0.0,a:1.0})
                material.setProp("_BackgroundColor",{r:1.0,g:1.0,b:1.0,a:1.0})
                material.setProp("_EdgeOnly",0.0);
                material.setProp('noiseTex',this.texture[0].getImpl());   
    ...
    public setShaderTexture(tex){
        this._sprite.spriteFrame.setTexture(tex);
        this._material.setTexture(tex);
    }
}
